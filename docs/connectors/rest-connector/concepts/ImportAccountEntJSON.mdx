...
## ImportAccountEntJSON
A ImportAccountEntJSON typically refers to a JSON formatted configuration section used in Saviynt to define to map account and entitlement attributes of the target application to account and entitlement attributes of IGA for account import.
