...
1.	Download [OpenAPI Spec](https://github.com/saviynt/ExternalConnectorFramework-APISpec/blob/main/spec/OpenAPISpec.yaml) file.
2.	Open Swagger Editor in web browser by navigating to [swagger.io](https://editor.swagger.io/)
