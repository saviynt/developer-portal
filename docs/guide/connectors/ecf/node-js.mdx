...
2. Download [Open API Spec](https://github.com/saviynt/ExternalConnectorFramework-APISpec/blob/main/spec/OpenAPISpec.yaml).
...
1. Go to web browser and navigate to [/docs](http://localhost:8080/docs)
